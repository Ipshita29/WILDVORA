        ...
        <div className="relative z-10 flex flex-col h-full p-10">
          ...
          <div className="mt-auto mb-10">
            ...
            <p className="text-white/75 text-base max-w-md leading-relaxed">
              Oversee operator listings, manage settlements, resolve customer disputes, and monitor ecosystem growth.
            </p>
          </div>
      ...
      <div className="w-full lg:w-[480px] bg-[#F5F0EB] flex flex-col items-center justify-center px-8 py-12 overflow-y-auto">
        <div className="w-full max-w-[380px]">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <h2 className="text-2xl font-extrabold text-gray-900 mb-1">Admin Panel</h2>
            <p className="text-sm text-gray-500 mb-6">Sign in to access the control center.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="admin@wildvora.com"
                  required
              ...
              <button id="btn-login" type="submit" disabled={loading}
                className="w-full h-12 bg-[#1A5F45] hover:bg-[#145038] text-white font-semibold rounded-full text-sm transition-all duration-150 disabled:opacity-60 cursor-pointer">
            ...
            <p className="text-center text-sm text-gray-500 mt-5">
              Need access?{' '}
              <Link to="/register" className="text-[#1A5F45] font-semibold hover:underline">Register Admin</Link>
            </p>
          </div>
          <p className="text-center text-xs text-gray-400 mt-5">© 2026 Wildvora. Control console.</p>
        </div>
      </div>
    </div>
  );
