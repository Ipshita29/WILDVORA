        ...
        <div className="relative z-10 flex flex-col h-full p-10">
          ...
          <div className="mt-auto mb-16">
            <h1 className="text-5xl font-extrabold text-white leading-tight mb-4 animate-fade-in">
              Manage operations,<br />moderation, payouts, and<br />disputes from one place.
            </h1>
          </div>
          {/* Pill badge */}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            {sent ? (
              <div className="text-center">
                ...
                <Link to="/login"
                  className="block w-full h-12 bg-[#1A5F45] hover:bg-[#145038] text-white font-semibold rounded-full text-sm flex items-center justify-center transition cursor-pointer">
                  ← Back to Login
                </Link>
              </div>
            ) : (
