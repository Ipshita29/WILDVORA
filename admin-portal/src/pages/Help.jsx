        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-5 rounded-2xl bg-white border border-gray-100 shadow-sm flex flex-col gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-900">Need Tech Support?</h4>
                <p className="text-xs text-gray-500 mt-1 leading-relaxed">If there are payout delays or database replication issues, escalate directly to the engineering team.</p>
              </div>
              <button className="w-full py-2 bg-gray-900 hover:bg-gray-800 text-white font-bold text-xs rounded-xl shadow-sm transition cursor-pointer">
