        ...
        <div className="relative z-10 flex flex-col h-full p-10">
          ...
          <div className="mt-auto mb-10">
            <h1 className="text-5xl font-extrabold text-white leading-tight mb-4">
              Scale, moderate, and manage<br />India's premier adventure<br />marketplace.
            </h1>
            <p className="text-white/75 text-base max-w-sm leading-relaxed">
              Join the core administration team shaping the future of nature-based exploration in India.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[520px] bg-[#F5F0EB] flex flex-col items-center justify-center px-8 py-8 overflow-y-auto">
        <div className="w-full max-w-[420px]">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <h2 className="text-2xl font-extrabold text-gray-900 text-center mb-1">Create Admin Account</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input id="reg-email" type="email" placeholder="admin@wildvora.com" value={form.email} onChange={set('email')} required className={inputCls} />
              </div>

              <div>
                <label className="block text-[11px] font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Phone Number</label>
                <input id="reg-phone" type="tel" placeholder="+91 90000 00000" value={form.phone} onChange={set('phone')} className={inputCls} />
              </div>
              ...
              <label className="flex items-start gap-2.5 cursor-pointer">
                ...
                <span className="text-sm text-gray-600 leading-relaxed">
                  I agree to the <span className="text-[#1A5F45] font-semibold hover:underline">Terms &amp; Conditions</span> and{' '}
                  <span className="text-[#1A5F45] font-semibold hover:underline">Privacy Policy</span>.
                </span>
              </label>

              <button id="btn-create-account" type="submit" disabled={loading}
                className="w-full h-12 bg-[#1A5F45] hover:bg-[#145038] text-white font-semibold rounded-full text-sm flex items-center justify-center gap-2 transition disabled:opacity-60 cursor-pointer">
